...
var bigintEncoder = require('./bigint-encoder.js');
var errors = require('./errors.js');

class LargeInt extends xdrType.XdrPrimitiveType {
  /**
   * @param {Array<Number|BigInt|String>} parts - Slices to encode
   */
  constructor(args) {
    super();
    this._value = bigintEncoder.encodeBigIntFromBits(args, this.size, this.unsigned);
  }
   ...
   */
  get unsigned() {
    throw new errors.XdrNotImplementedDefinitionError();
  }
   ...
   */
  slice(sliceSize) {
    return bigintEncoder.sliceBigInt(this._value, this.size, sliceSize);
  }
  ...
  static write(value, writer) {
    if (value instanceof this) {
      ...
      throw new errors.XdrWriterError(`${value} is not a ${this.name}`);
  ...
  static defineIntBoundaries() {
    const [min, max] = bigintEncoder.calculateBigIntBoundaries(
      this.prototype.size,
...
//# sourceMappingURL=large-int.js.map
