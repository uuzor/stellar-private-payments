...
class XdrWriter {
  ...
  constructor(buffer$1) {
    if (typeof buffer$1 === 'number') {
      buffer$1 = buffer.Buffer.allocUnsafe(buffer$1);
    } else if (!(buffer$1 instanceof buffer.Buffer)) {
      buffer$1 = buffer.Buffer.allocUnsafe(BUFFER_CHUNK);
    }
    this._buffer = buffer$1;
    this._length = buffer$1.length;
  }
  ...
  resize(minRequiredSize) {
    ...
    const newBuffer = buffer.Buffer.allocUnsafe(newLength);
...
//# sourceMappingURL=xdr-writer.js.map
