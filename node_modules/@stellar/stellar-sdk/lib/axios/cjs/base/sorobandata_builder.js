...
class SorobanDataBuilder {
  ...
  constructor(sorobanData) {
    let data;
    if (!sorobanData) {
      data = new curr_generated.default.SorobanTransactionData({
        resources: new curr_generated.default.SorobanResources({
          footprint: new curr_generated.default.LedgerFootprint({ readOnly: [], readWrite: [] }),
          instructions: 0,
          diskReadBytes: 0,
          writeBytes: 0
        }),
        ext: new curr_generated.default.SorobanTransactionDataExt(0),
        resourceFee: new curr_generated.default.Int64(0)
      });
  ...
  static fromXDR(data) {
    if (typeof data === "string") {
      return curr_generated.default.SorobanTransactionData.fromXDR(data, "base64");
    } else {
      return curr_generated.default.SorobanTransactionData.fromXDR(buffer.Buffer.from(data), "raw");
    }
  }
  /**
   ...
   */
  setResourceFee(fee) {
    this._data.resourceFee(new curr_generated.default.Int64(fee));
    return this;
  }
  /**
   ...
   */
  build() {
    return curr_generated.default.SorobanTransactionData.fromXDR(this._data.toXDR());
  }
  //
  // getters follow
  //
