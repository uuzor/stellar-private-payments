import { generateTypeImports, formatImports, sanitizeIdentifier, parseTypeFromTypeDef, formatJSDocComment } from './utils.js';
...
export class Client extends ContractClient {
 ...
 ${deployMethod}
  ...
  generateInterfaceMethod(func) {
    ...
    const outputType = func.outputs().length > 0 ? parseTypeFromTypeDef(func.outputs()[0]) : "void";
