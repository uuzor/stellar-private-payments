...
import { fetchClient } from '../http-client/fetch-client.js';
...
class FederationServer {
  ...
  constructor(serverURL, domain, opts = {}) {
    ...
    this.timeout = typeof opts.timeout === "undefined" ? Config.getTimeout() : opts.timeout;
  ...
  async _sendRequest(url) {
    ...
    return fetchClient.get(url.toString(), {
